...
func @run_elemwise(%tensor_a: tensor<10xf32>, %tensor_b :tensor<10xf32>, %tensor_c:tensor<10xf32>) -> tensor<10xf32>{
    ...
    %res_mid = linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel"]}
      ins(%tensor_a, %tensor_b : tensor<10xf32>,  tensor<10xf32>)
    ...
    %res_mid2 = linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel"]}
      ins(%res_mid, %tensor_c : tensor<10xf32>,  tensor<10xf32>)
     outs(%res_tensor : tensor<10xf32>) {
    ^bb0(%a: f32, %b: f32, %c: f32) :
      %4 = arith.addf %a, %b : f32
      linalg.yield %4 : f32
...
func @main() {
    ...
    %res_mid2 = call @run_elemwise(%fill_c1, %fill_c2, %fill_c5) : (tensor<10xf32>, tensor<10xf32>, tensor<10xf32>) -> tensor<10xf32>
